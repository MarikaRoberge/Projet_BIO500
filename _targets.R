...
tar_option_set(packages = c("dplyr", "RSQLite", "readr", "DBI", "tarchetypes", "sf", "ggplot2","canadianmaps", "rnaturalearth", "patchwork", "rmarkdown" )) #Ici, on met les packages qui seront nécessaires pour les différentes fonctions de nos différents scripts
}
